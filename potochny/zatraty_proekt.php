...
if (!$output_form){
    ...
    $query = "INSERT INTO r_zatraty_proekt (rnz, istochnik_oplat, data, statya_zatrat, suma_zatrat, manager, etc) VALUES ('$rnz', '$istochnik_oplat', '$data', '$statya_zatrat', '$suma_zatrat', '$manager', '$etc')";
    ...
    $table = "<table><tr><th>Номер договору</th><th>Джерело оплати</th><th>Дата оплати витрат</th><th>Стаття витрат</th>
	<th>Сума витрат</th><th>Менеджер</th><th>Примітки</th></tr>";
    ...
    <form id="Form" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
        <div>
            ...
            <div class="wrapper">
                ...
                <div class="bg">
                    <select name="statya_zatrat" class="select">
            ...
            <div class="wrapper">
                ...
                <div class="bg">
                    <input type="text" name="suma_zatrat" class="input" value="<?php echo $suma_zatrat; ?>">
                </div>
            </div>
            <div class="wrapper">
                <span>Менеджер: *</span>
