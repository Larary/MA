...
if (!$output_form){
    ...
    $query = "INSERT INTO r_oplaty (rnz, data, oplata_fakt, sposob_oplaty, etc) VALUES ('$rnz', '$data', '$oplata_fakt', '$sposob_oplaty', '$etc')";
    ...
    $table = "<table><tr><th>Номер договору</th><th>Дата оплати</th><th>Сума оплати</th><th>Спосіб оплати</th><th>Примітки</th></tr>";  
    ...
    <form id="Form" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
        <div>
            ...
            <div class="wrapper">
                ...
                <div class="bg">
                    <input type="text" name="oplata_fakt" class="input" value="<?php echo $oplata_fakt; ?>">
                </div>
            </div>
            <div class="wrapper">
                <span>Спосіб оплати: *</span>
                <div class="bg">
                    <select name="sposob_oplaty" class="select">
