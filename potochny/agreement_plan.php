...
if (!$output_form){
    ...
    $query = "INSERT INTO r_reestr2 (rnz, zatraty_plan, premia, stadiya, data_planovo, data_vykon, nalogi, geodezia, agentskie, bonus, pribil_plan, etc)
    ...
    $table = "<table><tr><th>Номер договору</th><th>Планові витрати</th><th>Премія</th><th>Стадія робіт</th>
			<th>Планова дата виконання</th><th>Фактична дата виконання</th><th>Податки</th><th>Геодезія</th><th>Агентські</th>
			<th>Бонус</th><th>План прибутку</th><th>Примітки</th></tr>";
    ...
    <form id="Form" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" >
        <div>
            <div class="wrapper">
                ...
                <div class="bg">
                    <select name="rnz" id="rnz" class="select">
                        <option value="0">Оберіть договір</option>
                            ...
                            if (mysqli_num_rows($choice)!=0){
                                ...
                                echo "<option value=''>Відсутні нові договори для внесення даних. 
            ...
            <div  class="wrapper">
                ...
                <div class="bg">
                    <select name="summa_rabot" id="summa_rabot" class="select" onchange="pribilPlan()">
            ...
            <div  class="wrapper">
                ...
                <div class="bg">
                    <input type="text" name="zatraty_plan" id="zatraty_plan" class="input" oninput="pribilPlan()" value="<?php echo $zatraty_plan; ?>">
                </div>
            </div>
            <div  class="wrapper">
                <span>Сума премії:</span>
                <div class="bg">
                    <input type="text" name="premia" id="premia" class="input" oninput="pribilPlan()" value="<?php echo $premia; ?>">
                </div>
            </div>
            <div  class="wrapper">
                <span>Стадія робіт за договором:</span>
                <div class="bg">
                    <select name="stadiya" class="select">
            ...
            <div  class="wrapper">
                ...
                <div class="bg">
                    <input type="date" name="data_planovo" class="input" value="<?php echo $data_planovo; ?>" >
                </div>
            </div>
            <div  class="wrapper">
                <span>Фактична дата виконання робіт:</span>
                <div class="bg">
                    <input type="date" name="data_vykon" class="input" value="<?php echo $data_vykon; ?>" >
                </div>
            </div>
            <div  class="wrapper">
                <span>Податки:</span>
                <div class="bg">
                    <input type="text" name="nalogi" id="nalogi" class="input" oninput="pribilPlan()" value="<?php echo $nalogi; ?>">
                </div>
            </div>
            <div  class="wrapper">
                <span>Геодезія:</span>
                <div class="bg">
                    <input type="text" name="geodezia" id="geodezia" class="input" oninput="pribilPlan()" value="<?php echo $geodezia; ?>">
                </div>
            </div>
            <div  class="wrapper">
                <span>Агентські:</span>
                <div class="bg">
                    <input type="text" name="agentskie" id="agentskie" class="input" oninput="pribilPlan()" value="<?php echo $agentskie; ?>">
                </div>
            </div>
            <div  class="wrapper">
                <span>Бонус:</span>
                <div class="bg">
                    <input type="text" name="bonus" id="bonus" class="input" oninput="pribilPlan()" value="<?php echo $bonus; ?>">
                </div>
            </div>
            <div  class="wrapper">
                <span>План прибутку:</span>
                <div>
                    <output name="pribil_plan" id="pribil_plan" class="output"></output>
                </div>
            </div>
