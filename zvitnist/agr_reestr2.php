...
?>
    ...
    <form action="" method="get"> <!-- res_pp = results_per_page = количество строк на странице  -->
        <div>
            ...
            <select name="res_pp" id="res_pp" onchange="resultsPerPage()"> 
...
//Формируем отдельно заголовки таблицы для сохранения в CSV и PDF, $table_header - для CSV  и вывода на экран 
