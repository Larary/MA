...
if (!$output_form){
    ...
    $query = "INSERT INTO tip_rabot (tip_rabot_kratko, tip_rabot_full) VALUES ('$tip_rabot_kratko', '$tip_rabot_full')";
    ...
    $table = "<table><tr><th>Тип робіт коротко</th><th>Тип робіт повністю</th></tr>";
    ...
    <form id="Form" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
        <div>
            <div  class="wrapper">
                ...
                <div class="bg">
                    <input type="text" name="tip_rabot_kratko" class="input" value="<?php echo $tip_rabot_kratko; ?>"/>
                </div>
            </div>
            <div  class="wrapper">
                <span>Тип робіт повністю: *</span>
                <div class="bg">
                    <input type="text" name="tip_rabot_full" class="input" value="<?php echo $tip_rabot_full; ?>"/>
                </div>
            </div>
