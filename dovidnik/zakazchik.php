...
require_once('../include/dbconnect.php'); //Подключаем файл с параметрами подключения к БД
 ...
 //Присваиваем переменным нулевые значения, чтобы выводимая пустая форма не выдавала ошибки
  ...
  if (!$output_form){
    ...
    $query = "INSERT INTO zakazchik (name, kontakt, address, phone, email, etc) " .
    "VALUES ('$name', '$kontakt', '$address', '$phone', '$email', '$etc')";
    ...
    $table = "<table>";
       ...
       $table .= "<th>".'Назва/ПІБ замовника'."</th>";
       $table .= "<th>".'Контактна особа'."</th>";
       $table .= "<th>".'Адреса'."</th>";
       $table .= "<th>".'Телефон'."</th>";
       $table .= "<th>".'E-mail'."</th>";
	...
	<form id="Form" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
		<div>
			<div  class="wrapper">
				...
				<div class="bg"><input type="text" name="name" class="input" value="<?php echo $name; ?>"/></div>
			</div>
			<div  class="wrapper">
				<span>Контактна особа:</span>
				<div class="bg"><input type="text" name="kontakt" class="input" value="<?php echo $kontakt; ?>" ></div>
			</div>
			<div  class="wrapper">
				<span>Адреса замовника:</span>
				<div class="bg"><input type="text" name="address" class="input" value="<?php echo $address; ?>"></div>
			</div>
			<div  class="wrapper">
				<span>Телефон замовника:</span>
				<div class="bg"><input type="text" name="phone" class="input" value="<?php echo $phone; ?>"></div>
			</div>
			<div  class="wrapper">
				<span>E-mail замовника:</span>
				<div class="bg"><input type="text" name="email" class="input" value="<?php echo $email; ?>"></div>
			</div>
