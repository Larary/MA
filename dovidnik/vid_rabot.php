...
require_once('../include/dbconnect.php'); //Подключаем файл с параметрами подключения к БД
 ...
 if (!$output_form){
    ...
    $query = "INSERT INTO vid_rabot (vid_rabot_kratko, vid_rabot_full, tip_rabot) " .
    "VALUES ('$vid_rabot_kratko', '$vid_rabot_full', '$tip_rabot')";
    ...
    $table = "<table>";
       ...
       $table .= "<th>".'Вид робіт коротко'."</th>";
	   $table .= "<th>".'Вид робіт повністю'."</th>";
	   $table .= "<th>".'Тип робіт'."</th>";
       $table .= "</tr>";
	...
	<form id="Form" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
		<div>
			<div  class="wrapper">
				...
				<div class="bg"><input type="text" name="vid_rabot_kratko" class="input" value="<?php echo $vid_rabot_kratko; ?>"/></div>
			</div>
			<div  class="wrapper">
				<span>Вид робіт повністю: *</span>
				<div class="bg"><input type="text" name="vid_rabot_full" class="input" value="<?php echo $vid_rabot_full; ?>"/></div>
			</div>
			<div  class="wrapper">
				<span>Тип робіт: *</span>
				<div class="bg"><select name="tip_rabot" class="select">
