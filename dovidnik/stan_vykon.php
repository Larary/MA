...
if (!$output_form){
    ...
    $query = "INSERT INTO stan_vykon (stan_vykon, etc) VALUES ('$stan_vykon', '$etc')";
    ...
    $table = "<table><tr><th>Стан виконання робіт</th><th>Примітки</th></tr>";
    ...
    <form id="Form" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
        <div>
            <div  class="wrapper">
                ...
                <div class="bg">
                    <input type="text" name="stan_vykon" class="input" value="<?php echo $stan_vykon; ?>"/>
                </div>
            </div>
